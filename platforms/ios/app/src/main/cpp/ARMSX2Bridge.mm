...
// gated off when targeting the sim. isMetalFXSupported returns NO on sim builds
// (PCSX2_HAS_METALFX=0) without ever referencing MTLFXSpatialScalerDescriptor.
...
// returns NO on pre-iOS-16, the simulator (statically compiled out), and any GPU
// that fails the framework capability probe.
